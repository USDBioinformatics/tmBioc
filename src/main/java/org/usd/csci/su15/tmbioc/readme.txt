...
A. [Client side program]
	...
	[PERL]
	Instruction:
		perl RESTful.client.pl [POST] [Input file] [Trigger:tmChem|tmVar|DNorm|GNormPlus] Submit:[E-mail](optional)
		perl RESTful.client.pl [POST] [Input file] GNormPlus [taxonomy ID]
	Example:
		$ perl RESTful.client.pl POST input.json tmChem
		$ perl RESTful.client.pl POST input.json tmChem Submit:test@gmail.com
		$ perl RESTful.client.pl POST input.json GNormPlus 10090
